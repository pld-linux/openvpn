...
Name:		openvpn
Version:	1.5
Release:	0.12.1@%{_kernel_series}
License:	GPL
Group:		Networking/Daemons
Source0:	http://dl.sourceforge.net/openvpn/%{name}-%{version}_beta12.tar.gz
# Source0-md5:	62cc246e2eef1e33d98a9d2b4edd3a23
Source1:	%{name}.init
