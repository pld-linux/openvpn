...
Name:		openvpn
Version:	1.5
Release:	0.14.1@%{_kernel_series}
License:	GPL
Group:		Networking/Daemons
Source0:	http://dl.sourceforge.net/openvpn/%{name}-%{version}_beta14.tar.gz
# Source0-md5:	adb98940639d7cffb6ca69d81573f821
Source1:	%{name}.init
